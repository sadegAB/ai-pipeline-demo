...
class AIManager:
    ...
    def _review_file(self, task: Dict[str, Any], proposed_content: str, target_file: str) -> str:
        review_prompt = (
            ...
            "actionable feedback on what to fix. Do not provide a full corrected file unless absolutely necessary. "
            "Check: imports, required fields, framework consistency, no forbidden files, "
            "no unnecessary packages, no database logic inside schemas, no auth unless requested."
        )
